...
SQL;
    ...
    public function getCollection(FilterNormalizer $filters = null, $page = 1, $limit = 30)
    {
        $collection = parent::getCollection($filters, $page, $limit); // TODO: Change the autogenerated stub
