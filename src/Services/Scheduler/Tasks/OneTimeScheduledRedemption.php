...
class OneTimeScheduledRedemption extends ScheduledTask
{
    ...
    public function setAutoRedemption(OneTimeAutoRedemption $autoRedemption)
    {
        $this->autoRedemption = $autoRedemption;
    }

    public function getAutoRedemption(): OneTimeAutoRedemption
    {
    ...
    public function getProgram(): Program
    {
        if ($this->program === null) {
            $this->program = $this->getProgramService()
                ->getSingle($this->getAutoRedemption()->getProgramId(), true);
        }
